    ...
    <div className="flex flex-col md:flex-row md:items-start justify-center gap-4 min-h-screen !mt-20 px-4 !overflow-hidden">
      ...
      <div className="md:w-1/2 flex flex-col bg-white p-6 space-y-6">
        ...
        <div>
          ...
          <h1 className="font-bold text-xl !mt-6 !mb-1">{price} $</h1>
          <p className="text-red-600 font-semibold text-sm !mb-8">
            SHIPPING IS FREE ON NEW SEASON PRODUCTS
          </p>
        </div>

        {/* Ürün Kodu ve Renk */}
        <div className="text-sm text-gray-700">
          <p>5SAK50116UW999 | Color: Black</p>
        </div>

        {/* Beden Seçenekleri */}
        <div>
          <h4 className="text-sm font-bold !mt-8 !mb-2">SIZE</h4>
        ...
        <div>
          <h4 className="text-sm font-bold !mb-3">More Detail</h4>
